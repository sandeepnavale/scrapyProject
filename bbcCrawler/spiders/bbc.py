...
class BbcSpider(CrawlSpider):
    ...
    def update_rules(self):
        ...
        If multiple rules match the same link, the first one will be used, according to the order they’re defined in
        this attribute.
        """
        for r in self.ruleFile["rules"]:
            ...
            BbcSpider.rules.append(Rule(
                ...
                # callback is a callable or a string (in which case a method from the spider object with that
                # name will be used) to be called for each link extracted with the specified link_extractor.
                # This callback receives a response as its first argument and must return a list containing Item and/or
